...
// Dom Ready
	...
	$(function() {
		...
		if( $('.live-complete-post-carousel-widgets').length ){
			...
			$(".live-complete-post-carousel-widgets").owlCarousel({
				stagePadding: 0,
				loop: true,
				autoplay: true,
				...
				responsive: {
					0: {
						items: ( $(".live-complete-post-carousel-widgets").data('xs') != "" ) ? $(".live-complete-post-carousel-widgets").data('xs') : 1
					},
					600: {
						items: ( $(".live-complete-post-carousel-widgets").data('sm') != "" ) ? $(".live-complete-post-carousel-widgets").data('sm') : 1
					},
					1000: {
						items: ( $(".live-complete-post-carousel-widgets").data('md') != "" ) ? $(".live-complete-post-carousel-widgets").data('md') : 1
					}
				}
			});
		}
		...
		$(".responsive-submenu-toggle").keyup(function (e) {
  		...
  		$(".live-complete-rd-navbar-toggle").on('click', function(e){
			$('#navbar').toggleClass('active');
			$(this).find('i').toggleClass('icofont-arrow-left').toggleClass('icofont-navigation-menu');
			trapFocusInsiders( $('#navbar') );
	    });
	    $(".live-complete-navbar-close").on('click', function(e){
			$('#navbar').removeClass('active');
			$(".live-complete-rd-navbar-toggle").find('i').removeClass('icofont-arrow-left').addClass('icofont-navigation-menu');
	    });	
