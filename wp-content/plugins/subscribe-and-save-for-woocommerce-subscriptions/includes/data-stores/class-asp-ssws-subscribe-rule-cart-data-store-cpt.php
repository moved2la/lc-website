...
/**
 * Cart Subscribe Rule Data Store CPT
 * 
 * @class ASP_SSWS_Subscribe_Rule_Cart_Data_Store_CPT
 * @package Class
 */
class ASP_SSWS_Subscribe_Rule_Cart_Data_Store_CPT extends ASP_SSWS_Subscribe_Rule_Data_Store_CPT {
	...
	protected $internal_meta_key_to_props = array(
		...
		'_criteria_min_subtotal' => 'criteria_min_subtotal',
		'_criteria_max_subtotal' => 'criteria_max_subtotal',
	);

	/**
	 * Get the title to save to the post object.
	 *
	 * @param  ASP_SSWS_Subscribe_Rule_Cart $rule
	 * @return string
	 */
	protected function get_post_title( $rule ) {
		return $rule->get_name() ? $rule->get_name() : __( 'Cart Subscribe Rule', 'subscribe-and-save-for-woocommerce-subscriptions' );
	}
}
