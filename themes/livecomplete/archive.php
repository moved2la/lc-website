...
<div class="section-title">
    <div class="content">
        <div class="heading"><?php echo esc_html($current_category->name); ?></div>
    </div>
</div>
...
<div class="blog-grid">
    ...
    // Modify the query to only get posts from current category
    $args = array(
        'post_type' => 'post',
        'posts_per_page' => -1,
    ...
    if ($blog_posts->have_posts()) :
        while ($blog_posts->have_posts()) : $blog_posts->the_post();
            // Use the current category name for display
            $display_category = $current_category->name;
                    ...
                    <div class="content2">
                        <div class="info">
                            <div class="article-category">
                                <div class="text"><?php echo esc_html(ucwords($display_category)); ?></div>
                            </div>
